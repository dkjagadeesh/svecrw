...
<html>
	...
	<body>
		...
		<form class="form-horizontal" action="addseminars.php" method="post">
			<!-- Form Name -->
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="title">Title of Seminar/Workshop/Conference</label>  
				<div class="col-md-4">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="dov" name="dov" type="text" placeholder="Enter in DD/MM/YYYY" class="form-control input-md">
				</div>
			</div>
